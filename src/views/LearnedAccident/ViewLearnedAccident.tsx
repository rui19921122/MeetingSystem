...
export class ViewLearnedAccident extends React.Component<Props, void> {
    constructor(props) {
        super(props)
    }
    componentDidMount() {
        this.props.dispatch(actions.get_learned_accident())
    }
    render() {
            ...
            <Row>
                ...
                <Col span={20}>
                    ...
                    <Row type='flex' justify='center' className='table'>
                        <Col span={20}>
                            <Table dataSource={this.props.accident.items_learned}
                                columns={colunms}
...
export default connect(mapStateToProps)(ViewLearnedAccident)
