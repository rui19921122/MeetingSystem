...
class Login extends React.Component {
    ...
    render() {
        return (React.createElement(antd_1.Form, {horizontal: true, onSubmit: this.handleSubmit}, React.createElement(antd_1.Form.Item, {id: "username", label: "用户名", labelCol: { span: 6, offset: 0 }, wrapperCol: { span: 14, offset: 0 }}, React.createElement(antd_1.Input, {id: "username", placeholder: "请输入您的用户名"})), React.createElement(antd_1.Form.Item, {id: "password", label: "密码", labelCol: { span: 6, offset: 0 }, wrapperCol: { span: 14, offset: 0 }}, React.createElement(antd_1.Input, {id: "password", type: "password", placeholder: "请输入您的密码"})), React.createElement(antd_1.Row, null, React.createElement(antd_1.Col, {span: 16, offset: "6"}, React.createElement(antd_1.Button, {type: "primary", htmlType: "submit"}, "登陆")))));
    }
}
