...
class ManageCheckView extends React.Component {
    ...
    render() {
        ...
        return (React.createElement(antd_1.Row, null, React.createElement(antd_1.Col, {span: 4}, React.createElement(Menu_1.default, {menu: this.props.menu, dispatch: this.props.dispatch})), React.createElement(antd_1.Col, {span: 20}, React.createElement(antd_1.Row, null, React.createElement(antd_1.Col, null, React.createElement("h1", {className: "title-header"}, "预考勤模块"))), React.createElement(antd_1.Row, {type: "flex", justify: "center"}, React.createElement(antd_1.Col, null, React.createElement("span", null, "日期: "), React.createElement(antd_1.DatePicker, {defaultValue: new Date(), ref: 'date-picker', onChange: this.DatePickerChange.bind(this)}), React.createElement("span", null, " 班次: "), React.createElement(antd_1.Select, {defaultValue: "1", ref: 'selection', onChange: this.SelectChange.bind(this)}, React.createElement(Option, {value: "1"}, "白班"), React.createElement(Option, {value: "2"}, "夜班")), React.createElement(antd_1.Button, {onClick: this.QueryButtonClick.bind(this)}, "查询"))), lock ? React.createElement(antd_1.Row, {type: "flex", justify: 'center'}, React.createElement(antd_1.Col, null, React.createElement("h2", null, "考勤表已锁定，无法修改"))) : '', React.createElement(antd_1.Row, {type: "flex", justify: 'center', className: "table"}, React.createElement(antd_1.Col, {span: 20}, React.createElement(antd_1.Table, {dataSource: this.props.manage_check.items.person, columns: Columns, rowKey: record => record.id, pagination: false}), this.props.manage_check.items.id && !lock ?
            React.createElement(antd_1.Row, {type: 'flex', justify: 'center'}, React.createElement(antd_1.Col, null, React.createElement(antd_1.Button, {onClick: event => this.props.dispatch(manage_check_1.actions.AddModalShow(true))}, "添加新学员")))
            : '', React.createElement(antd_1.Modal, {title: "请选择代替的职工", footer: '', visible: this.props.manage_check.showModal, onCancel: this.props.dispatch(v => () => this.props.dispatch(manage_check_1.actions.showModal(false)))}, React.createElement(antd_1.Radio.Group, {defaultValue: '', onChange: event => this.props.dispatch(manage_check_1.actions.ReplaceData(this.props.manage_check.replaceId, event.target.value))}, this.getRadioSelect())), React.createElement(antd_1.Modal, {title: "请选择增加的职工", footer: '', visible: this.props.manage_check.addModalShow, onCancel: this.props.dispatch(v => () => this.props.dispatch(manage_check_1.actions.AddModalShow(false)))}, React.createElement(AddStudyWorkerForm_1.default, {position: this.props.position, worker: this.props.worker, dispatch: this.props.dispatch, manage_check: this.props.manage_check})))))));
    }
}
